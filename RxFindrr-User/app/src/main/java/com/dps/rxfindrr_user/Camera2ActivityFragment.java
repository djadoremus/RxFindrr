...
import com.dps.rxfindrr_user.textureview.AutoFitTextureView;
...
public class Camera2ActivityFragment extends Fragment
    ...
    private int getRotationCompensation(String cameraId, Activity activity, Context context)
        ...
        Log.d(TAG, "--getRotationCompensation " + result);
        return result;
    }
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            /*
            Start Firebase ML Kit
            */
            Log.d(TAG, "--onImageAvailable --calling ML Kit");
            try {
                FirebaseVisionImage image = FirebaseVisionImage.fromMediaImage(
                        reader.acquireNextImage(),
                        getRotationCompensation(mCameraId,
                                Camera2ActivityFragment.this.getActivity(),
                                Camera2ActivityFragment.this.getContext()));
                visionController = new VisionController(Camera2ActivityFragment.this.getContext(), image);
                Boolean isQR = Boolean.FALSE;
                if (isQR){
